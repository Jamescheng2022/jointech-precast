...
export const metadata: Metadata = {
  ...
  description:
    "JoinTech Precast — global B2B supplier of pile splice plates, tunnel segment couplers, prestress anchors and more. Technical expertise meets reliable supply.",
};
...
const advantages = [
  ...
  },
  {
    ...
    desc: "OEM and bespoke manufacturing available. From drawing to delivery — full traceability and mill test certificates.",
  },
];
        ...
        <div className="container relative mx-auto px-4 md:px-6 py-20">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-blue-100 leading-relaxed mb-10 max-w-2xl">
              ...
              — we supply the engineered hardware that holds precast structures
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-14">
            ...
            <p className="text-gray-500 max-w-xl mx-auto">
              From metro tunnels to high-speed rail — our hardware is embedded
