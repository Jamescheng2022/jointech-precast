      ...
      <div className="bg-primary-900 py-16">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <p className="text-blue-200 max-w-2xl">
            ...
            hardware 鈥?built on two decades of structural engineering expertise.
          </p>
        </div>
      </div>
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-500 leading-relaxed">
                ...
                <p>
                  ...
                  steel strands, and railway sleeper fastener inserts 鈥?all
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
            {[
              ...
              },
              {
                ...
                desc: "OEM orders accepted. From material selection to surface treatment and packaging 鈥?we adapt to your project specs.",
              },
              {
                icon: Award,
